...
public interface IGatewayCategoryService
{
	...
	@PostMapping(value = "/valid/category/condition")
	ResultDTO<List<CategoryDTO>> findCategoriesOnCondition(@RequestBody Map<String, Object> condition);

	@PostMapping(value = "/valid/category/delete", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	ResultDTO<Integer> deleteCategories(@RequestBody UserRequestDTO userRequestDTO);
}
