...
<head>
	...
	<script src="/js/jquery/2.0.0/jquery.min.js"></scsript>
	...
	<!--<link href="http://how2j.cn/study/css/back/style.css" rel="stylesheet">-->
	<!--<link href="/css/back/style.css" rel="stylesheet">-->
	
	
	<link href="/css/back/tmall.css" rel="stylesheet">
<script>
...
<div id="loginDiv" style="position: relative">
	...
	<img id="loginBackgroundImg" class="loginBackgroundImg" src="http://how2j.cn/tmall/img/site/loginBackground.png">
	...
	<form class="loginForm"  method="post" action="login.do">
		<div id="loginSmallDiv" class="loginSmallDiv">
			...
			<div class="loginInput " >
				...
				<input id="name" name="email" placeholder="邮箱" type="text">			
			</div>
			...
			<div style="margin-top:20px">
				<input class="btn btn-block redButton" type="submit" value="登录">
				<a class="btn btn-block redButton" href="http://localhost:8095/wechat/wechat-login/portal">微信登陆</a>
			</div>
		</div>	
	</form>
