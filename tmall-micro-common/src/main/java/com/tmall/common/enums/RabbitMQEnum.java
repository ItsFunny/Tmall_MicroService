...
public enum RabbitMQEnum
{
	...
	USER_OFFLINE_BY_FORCE(RabbitMQExchangeNameConstant.USER, "CHANGE_BY_MANAGER", "OFFLINE"),

	// 因后台管理而使得用户状态发生改变->单单只是状态改变,如添加了权限等
	USER_STATUS_CHANGE_BY_MANAGER(RabbitMQExchangeNameConstant.USER, "CHANGE_BY_MANAGER", "AUTH_CHANGE"),
	
	USER_ACCOUNT_CREATED(RabbitMQExchangeNameConstant.USER,"",""),
	
	USER_LOGOUT(RabbitMQExchangeNameConstant.USER,"",""),
	
	USER_DEAL_WITH_PRODUCT(RabbitMQExchangeNameConstant.USER,"","USER_DEAL_WITH_PRODUCT"),
	;
