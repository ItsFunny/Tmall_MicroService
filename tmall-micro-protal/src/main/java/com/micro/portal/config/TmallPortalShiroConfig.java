...
public class TmallPortalShiroConfig
{
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(KeyProperties keyProperties, INosqlService redisService,
			FeginLoginServerService serverService)
	{
		ShiroFilterFactoryBean shiroFilterFactoryBean = new ShiroFilterFactoryBean();
		shiroFilterFactoryBean.setSecurityManager(securityManager());
		Map<String, Filter> filters = shiroFilterFactoryBean.getFilters();
		filters.put("authc", checkUserLoginFilter(keyProperties, redisService, serverService));
