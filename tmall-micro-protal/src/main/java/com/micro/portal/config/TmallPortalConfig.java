...
public class TmallPortalConfig implements InitializingBean
{
	...
	@Bean
	public FilterRegistrationBean<Filter> checkLoginFilter(INosqlService redisService)
	{
		FilterRegistrationBean<Filter> filterRegistrationBean = new FilterRegistrationBean<>();
		filterRegistrationBean.setFilter(new CheckUserLoginFilter(keyProperties,redisService));
