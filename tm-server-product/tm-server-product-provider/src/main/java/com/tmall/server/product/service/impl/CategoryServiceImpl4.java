...
// */
//@Slf4j
//public class CategoryServiceImpl4 extends AbstractPageService<List<CategoryDTO>> implements ICategoryService
//{
//
//	@Autowired
...
//
//	// private class InnerSQLExtentionCRUDServiceImpl implements
//	// ISQLExtentionBaseCRUDService<TmallCategory>
//	// {
//	//
//	// @Override
//	// public Integer insert(String tableName, Long hashCodeOrId, TmallCategory t)
//	// {
//	// SQLExtentionDaoWrapper<TmallCategory> wrapper = holder.getBaseDao(tableName,
//	// hashCodeOrId);
...
//	//
//	// @Override
//	// public Integer update(String tableName, Number id, TmallCategory t, Object
//	// example)
//	// {
//	// SQLExtentionDAOWrapper<Object> wrapper = holder.getBaseDao(tableName,
//	// id.longValue());
...
//	// {
//	// List<ISQLExtentionCRUDDao> daos =
//	// holder.getTableAllDaos(SQLExtentionConstant.CATEGORY);
...
//	{
//		List<? extends ISQLExtentionBaseCRUDDao<AbstractSQLExtentionModel>> daos = holder
//				.getAllDaos(SQLExtentionConstant.CATEGORY);
//		Long count = 0L;
//		if (null == condition || condition.isEmpty())
//		{
//
//			for (ISQLExtentionBaseCRUDDao<AbstractSQLExtentionModel> dao : daos)
//			{
//				count += dao.countByExample(null);
//			}
//			return count;
//		}
//		TmallCategoryExample example = new TmallCategoryExample();
...
//		// {
//		// List<TmallCategory> categories = dao.selectByExample(example);
//		// }
//		// 先这么写,再改
//		List<TmallCategory> categories = daos.get(0).selectByExample(example);
//		List<TmallCategory> db1Categories = daos.get(1).selectByExample(example);
...
//			db1Categories2 = daos.get(1).selectByExample(example);
//			db0Categories2 = categories;
//		} else
//		{
//			criteria.andCategoryIdBetween(minCategoryId, db0MaxCatId);
//			db0Categories2 = daos.get(0).selectByExample(example);
