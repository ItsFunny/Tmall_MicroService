...
import com.tmall.server.auth.provider.dao.MenuDao;
import com.tmall.server.auth.provider.dao.TmallRoleMenuDao;
...
public class MenuServiceImpl implements IMenuService
{
	...
	public List<MenuDTO> findMenusByRoleId(Long roleId)
	{
		...
		com.tmall.server.auth.common.model.TmallMenuExample.Criteria menuCriteria = menuExample.createCriteria();
		menuCriteria.andMenuIdIn(menuidList);
