...
* 
*/
package com.tmall.server.auth.server.controller;
...
public class RestAuthController
{
	...
	public ResultDTO<String> getAuthToken(@RequestBody String token)
	{
		...
		/*
		 * 1.通过userId和storeId得到roleId
		 * 2.通过roleId得到menus和actions
		 */
		...
		{	
			...
			List<ActionDTO> permissions = permissionService.findRolePermissionByRoleId(role.getRoleId(),
